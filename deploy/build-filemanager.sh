...
# Pages web racine
for f in index.php login.php logout.php dashboard.php medicaments.php medicaments_import.php achats.php achats_import.php stock.php diagnostic.php install_migration.php \
