-- ============================================================
-- NOUVELLE EVE — Base de données COMPLÈTE (installation neuve)
-- Pharmacie Nouvelle Eve — mapharmaciepk.xo.je
-- ============================================================
-- Importez ce fichier dans phpMyAdmin sur la base :
--   if0_42810781_mapharmacieEve
--
-- ATTENTION : si des tables existent déjà, utilisez plutôt :
